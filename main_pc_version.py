...
def show_game_over_screen(current_score):
    while True:
        ...
        screen.fill(BLACK)
        print_text('GAME OVER', font_big, WHITE, 300, 200)
        print_text('SCORE: ' + str(current_score) + ' m', font_big, WHITE, 290, 250)
        print_text('PRESS SPACE TO PLAY AGAIN', font_big, WHITE, 180, 300)
        pygame.display.flip()
        clock.tick(FPS)
